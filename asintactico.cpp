...
Ingenier�a de Sistemas - U.F.P.S
Rama Mater
*/
...
void lista::AnalizarFormula()
{
		...
		case 'A':
			{
				switch(aux->valor)
				{
				case '(': estado='B';PA++;break;
				case '*': estado='B';break;
				case 'p': 
				case 'q': 
				case 'r': 
				case 's': estado='C';break;
				//Trancisiones a error
				case ')': cout<<" No debe iniciar una formula con ')'";FBFormada=false;break;
				case '&': 					
				case '|': 					
				case '-': 					
				case '=': cout<<" No debe iniciar una formula con una conectiva binaria";
						  FBFormada=false;break;					
				default : cout<<" Caracter no pertenece al alfabeto";FBFormada=false;break;
				}
				break;
			}
			case 'B':
			{
				...
				case 's': estado='C';break;
				//Trancisiones a error
				case ')': cout<<" Despues de Negacion o de '(' no debe cerrar parentisis";
						  FBFormada=false;break;
				case '&': 					
				case '|': 					
				case '-': 					
				case '=': cout<<" Despues de Negacion o de '(' no debe ir una conect. binaria";
						  FBFormada=false;break;									
				default : cout<<" Caracter no pertenece al alfabeto ";FBFormada=false;break;
				}
				break;
		...
		case 'C':
			{
				...
				case '-': 					
				case '=': estado='D';break;					
				case ')': estado='E';PC++;break;					
				//Trancisiones a error
				case 'p': 
				case 'q': 
				case 'r': 
				case 's': cout<<" Despues de un simb de proposicion (p,q,r,s) no debe ir otro";
						  FBFormada=false;break;
				case '*': cout<<" Despues de un simb. de proposicion no debe ir negacion";
						  FBFormada=false;break;
				case '(': cout<<" Despues de un simb. de proposicion no debe abrir parentisis";
						  FBFormada=false;break;
				default : cout<<" Caracter no pertenece al alfabeto";FBFormada=false;break;		
				}
				break;
		...
		case 'D':
			{
				...
				case '*': estado='B';break;
				//Trancisiones a error
				case ')': cout<<" Despues de una conectiva binaria no debe cerrar parentisis";
						  FBFormada=false;break; 
				case '&': 					
				case '|': 					
				case '-': 					
				case '=': cout<<" Despues de una conectiva binaria no debe ir otra.";
						  FBFormada=false;break;									
				default : cout<<" Caracter no pertenece al alfabeto";FBFormada=false;break;		
				}
				break;
		...
		case 'E':
			{
				...
				case 'q': 
				case 'r': 
				case 's': cout<<" Despues de ')' no debe ir un simb. de proposicion (p,q,r,s)";
						  FBFormada=false;break;
				case '*': cout<<" Despues de ')' no debe ir la conectiva unaria negacion";
						  FBFormada=false;break;
				case '(': cout<<" Despues de cerrar parentisis no debe abrir parentisis";
						  FBFormada=false;break;
				default : cout<<" Caracter no pertenece al alfabeto";FBFormada=false;break;		
				}
				break;
	...
	if(FBFormada){
		...
		else cout<<"FORMULA BIEN FORMADA"<<endl;
	}
	else cout<<"FORMULA MAL FORMADA"<<endl;
}
//**************************************************************************
int main()
{
  ...
  cout<<"- - - - - - - - - - - - - - JOEL MARTIN PRADA GARCIA  0151582 - - - - - - - - -"<<endl;  
  cout<<"- - - - - - - - - - - - - - - - - - - U   F   P  S - - - - - - - - - - -  - - -"<<endl;  
  cout<<"-------------------------------------------------------------------------------"<<endl;
